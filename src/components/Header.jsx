...
const SearchBar = () => (
  <label
    className="hidden md:flex flex-col min-w-40 !h-10 
max-w-64"
  >
    <div className="flex w-full flex-1 items-stretch rounded-lg h-full">
      <div
        className="text-slate-500 flex border-none 
...
const NavLinks = () => (
  <>
    <a
      className="text-secondary dark:text-white dark:hover:text-green-400 text-xs sm:text-sm 
font-medium leading-normal py-2 transition-colors"
      href="#"
    >
      Dashboard
    </a>
...
font-medium leading-normal py-2 transition-colors"
    ...
    <a
      className="text-secondary dark:text-white dark:hover:text-green-400 text-xs sm:text-sm 
font-medium leading-normal py-2 cursor-pointer transition-colors"
      href="/study-hub"
    >
      StudyHub
    </a>
...
font-medium leading-normal py-2 transition-colors"
    ...
    <Link
      className="text-secondary dark:text-white dark:hover:text-green-400 text-xs sm:text-sm font-medium leading-normal py-2 transition-colors"
      to="/chat"
    >
      Chat
    </Link>
...
bg-cover rounded-full size-10"
      ...
      {isDropdownOpen && (
        ...
        >
          <a
            className="block px-4 py-2 text-sm text-secondary dark:text-white dark:hover:text-green-400 hover:bg-background-light dark:hover:bg-slate-800 transition-colors"
            href="#"
          >
            Profile
          </a>
...
dark:border-slate-700 px-4 sm:px-10 py-3 bg-white dark:bg-slate-900"
    >
      ...
      <div className="hidden lg:flex flex-1 justify-end gap-6">
        ...
        <button
          className="flex max-w-[480px] cursor-pointer 
