 ...
 * @param {Object} props
 * @param {Object} props.file - File object with data property
 * @param {number} [props.pageNumber] - Specific page to jump to
 * @param {boolean} props.isOpen - Modal visibility
 * @param {Function} props.onClose - Callback to close modal
 * @param {boolean} [props.isDarkMode] - Dark mode toggle
 */
const PDFModal = ({ file, pageNumber, isOpen, onClose, isDarkMode }) => {
