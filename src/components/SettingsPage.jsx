...
const ToggleSwitch = ({ checked, onChange }) => (
  <label className="relative inline-flex items-center cursor-pointer">
    ...
    <div
      className="w-11 h-6 bg-slate-200 dark:bg-slate-600 
...
dark:border-slate-600 peer-checked:bg-primary"
    ></div>
  </label>
);
...
const SettingsSection = ({ title, description, children }) => (
  <section className="mb-8">
    <h2
      className="text-lg sm:text-xl lg:text-2xl font-bold text-secondary dark:text-white 
mb-1"
    >
      {title}
    </h2>
    <p
      className="text-xs sm:text-sm lg:text-base text-slate-500 dark:text-slate-400 
mb-6"
    >
      {description}
    </p>
...
function SettingsPage() {
  ...
  useEffect(() => {
    ...
    const fontSize = Math.max(
      14,
      Math.min(19, sizeMap[settings.fontSize] ?? 16),
    );
        ...
        return (
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between py-4 border-b border-slate-200 dark:border-slate-700">
              <div>
                <h3 className="text-sm sm:text-base font-semibold text-secondary dark:text-white">
                  Email Address
                </h3>
            ...
            {editingPhone && (
              <div className="py-4 bg-slate-50 dark:bg-slate-800/50 p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">
                  Your phone number is used for creating your virtual bank
                  account and improving your wallet experience.
                </p>
              </div>
            )}
            ...
            <div className="py-4">
              <h3 className="text-base sm:text-lg font-semibold text-secondary dark:text-white mb-1">
                Notification Preferences
              </h3>
              <div className="space-y-4 pt-4">
                <div className="flex items-start justify-between">
                  <div className="max-w-md">
                    <h4 className="text-xs sm:text-sm font-medium text-secondary dark:text-white">
                      Email Notifications
                    </h4>
                    <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
                      Receive important updates, digests, and marketing
          ...
          >
            {privacyLoading ? (
              ...
              <div className="space-y-8">
                {/* Profile Visibility */}
                <div>
                  <h3 className="text-sm sm:text-base font-semibold text-secondary dark:text-white mb-4">
                    Profile Visibility
                  </h3>
                  <div className="space-y-4">
                    <div>
                      ...
                      >
                        ...
                        <option value="verified-only">
                          ✓ Verified Only (Only verified students)
                        </option>
                    ...
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      <input
                        type="checkbox"
                        checked={
                          privacySettings.includeInRecommendations !== false
                        }
                        onChange={(e) =>
                          handlePrivacySettingChange(
                    ...
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Let people add you to their followers
                        </p>
                      </div>
                    </label>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      <input
                        type="checkbox"
                        checked={
                          privacySettings.requireApprovalForMessages !== true
                        }
                        onChange={(e) =>
                          handlePrivacySettingChange(
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Uncheck to require approval before reading
                        </p>
                      </div>
                    </label>
                  </div>
                ...
                {/* Interactions */}
                <div>
                  <h3 className="font-semibold text-secondary dark:text-white mb-4">
                    Interactions
                  </h3>
                  <div className="space-y-4">
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      ...
                      <div>
                        <span className="text-sm font-medium text-secondary dark:text-white">
                          Allow Likes on Your Profile
                        </span>
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Let others like your profile
                        </p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Let users mention you in posts
                        </p>
                      </div>
                    </label>
                  </div>
                  ...
                  <div className="space-y-4">
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Display followers, sales, and activity
                        </p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Allow viewing your campus feed posts
                        </p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      ...
                      <div>
                        <span className="text-sm font-medium text-secondary dark:text-white">
                          Show My Marketplace Items
                        </span>
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Display your listed items for sale
                        </p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Let others view who follows you
                        </p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      <input
                        type="checkbox"
                        checked={
                          privacySettings.canSeeTransactionHistory !== true
                        }
                        onChange={(e) =>
                          handlePrivacySettingChange(
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Display your past sales and purchases
                        </p>
                      </div>
                    </label>
                  </div>
                  ...
                  <div className="space-y-4">
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Let others send you buying offers
                        </p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer">
                      ...
                      <div>
                        <span className="text-sm font-medium text-secondary dark:text-white">
                          Accept Seller Requests
                        </span>
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Let buyers request items from you
                        </p>
                      </div>
                    </label>
                  </div>
...
dark:border-slate-700"
            >
              <div>
                <h3
                  className="text-sm sm:text-base font-semibold text-secondary 
dark:text-white"
                >
                  Appearance
                </h3>
...
bg-background-light dark:bg-slate-700 p-1 mt-2 sm:mt-0"
              >
                <button
                  ...
                  className={`px-3 py-1 text-sm font-medium rounded-md transition-colors ${settings.theme === "light" ? "bg-white dark:bg-black text-secondary dark:text-white shadow-sm" : "text-slate-500 dark:text-slate-400"}`}
                >
                  Light
                </button>
                <button
                  onClick={() => handleThemeChange("dark")}
                  className={`px-3 py-1 text-sm font-medium rounded-md transition-colors ${settings.theme === "dark" ? "bg-white dark:bg-black text-secondary dark:text-white shadow-sm" : "text-slate-500 dark:text-slate-400"}`}
                >
                  Dark
                </button>
              </div>
...
text-sm"
                >
                  Adjust text size for better readability (locked to 14-19px for
                  mobile safety).
                </p>
              </div>
...
Settings`}
            description="Settings for this section are coming 
soon."
          ></SettingsSection>
        );
    }
...
tracking-light text-3xl font-bold leading-tight pb-8"
          >
            Settings
          </h1>
