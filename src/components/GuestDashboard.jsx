...
const GuestDashboard = () => {
  ...
  // Simple markdown renderer for bold text, images, italics, and links
    ...
    <div className="relative flex min-h-screen w-full flex-col">
      ...
      <main className="flex-1 px-4 sm:px-10 py-8">
        <div className="flex flex-col max-w-7xl mx-auto">
          <h1
            className="text-secondary dark:text-white tracking-light
...
shadow-md p-6 flex flex-col gap-4"
              >
                <p
                  className="text-secondary dark:text-white text-xl
font-bold"
                >
                  UniWallet
                </p>
...
text-sm"
                  ...
                  <p
                    className="text-secondary dark:text-white text-xl sm:text-2xl
font-semibold"
                  >
                    ₦15,000.00
                  </p>
                ...
                <div className="flex justify-center gap-2 sm:gap-3 mt-2 sm:mt-3">
                  <button
                    className="flex-1 rounded-lg h-10 sm:h-11 px-3 sm:px-4 bg-primary
text-white text-xs sm:text-sm font-bold hover:bg-primary/90 active:scale-95 transition-all"
                  >
                    Add Funds
                  </button>
                  <button
                    className="flex-1 rounded-lg h-10 sm:h-11 px-3 sm:px-4
bg-background-light dark:bg-slate-700 text-secondary
dark:text-white text-xs sm:text-sm font-bold hover:bg-background-light/80 dark:hover:bg-slate-600 active:scale-95 transition-all"
                  >
                    Send Money
                  </button>
                </div>
                <a
                  className="text-center text-primary text-xs sm:text-sm font-medium
mt-2 sm:mt-3 inline-block w-full"
                  href="#"
                >
...
shadow-md p-6 flex-1"
              >
                <p
                  className="text-secondary dark:text-white text-xl font-bold
mb-4"
                >
                  ...
                  {campusFeedPosts.map((post) => (
                    <div key={post.id} className="flex gap-4">
                      <img
                        ...
                        src={post.authorAvatar || "/default_avatar.png"}
                      />
                      <div className="flex-1">
                        <p
                          className="font-semibold text-secondary
