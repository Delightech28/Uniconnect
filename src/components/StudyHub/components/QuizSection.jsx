      ...
      {selectedTopic && (
        <div className="bg-white dark:bg-zinc-900 p-6 sm:p-12 rounded-[32px] sm:rounded-[50px] shadow-2xl border border-gray-200 dark:border-zinc-800 animate-in slide-in-from-bottom-4 duration-500 mt-8 sm:mt-12 w-full">
          ...
          <div className="flex flex-col gap-6 sm:gap-10 w-full">
            ...
            <button onClick={startQuiz} className="w-full py-4 sm:py-6 bg-unispace hover:bg-unispace/90 active:bg-unispace/80 text-gray-900 dark:text-white font-bold text-base sm:text-lg rounded-2xl sm:rounded-[24px] shadow-xl shadow-unispace/40 hover:shadow-2xl hover:shadow-unispace/50 active:scale-95 transition-all mt-4 sm:mt-6 bg-color-gray-500 dark:bg-gray-500">
              Begin Quiz
            </button>
          </div>
        </div>
