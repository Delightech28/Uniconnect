 ...
 * @param {Function} props.onStart - Callback to start quiz
 * @param {Function} props.onBack - Callback to go back
 * @param {boolean} [props.isDarkMode] - Dark mode toggle
 */
const QuizConfig = ({ topics, onStart, onBack, isDarkMode }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-6 h-full flex flex-col animate-fade-in relative transition-colors duration-300 bg-white dark:bg-secondary">
