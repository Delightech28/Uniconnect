...
<input className="form-input flex w-full min-w-0 flex-1 resize-none
overflow-hidden rounded-lg text-secondary dark:text-white
...
const NavLinks = () => (
<>
<a className="text-secondary dark:text-white text-sm font-medium
leading-normal" href="#">Dashboard</a>
<a className="text-secondary dark:text-white text-sm font-medium
leading-normal" href="#">Marketplace</a>
<a className="text-primary font-bold text-sm leading-normal"
href="#">Study Hub</a>
<a className="text-secondary dark:text-white text-sm font-medium
leading-normal" href="#">CampusFeed</a>
<a className="text-secondary dark:text-white text-sm font-medium
leading-normal" href="#">Wallet</a>
</>
);
const UserProfile = () => {
...
gap-2 text-sm font-bold leading-normal tracking-[0.015em] min-w-0
px-2.5">
<span
