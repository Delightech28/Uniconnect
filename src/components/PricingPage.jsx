...
const PricingPage = () => {
  ...
  const payAsYouGoOptions = [
    {
      ...
      features: [
        "Document Analysis",
        "Re-take for the same topic ₦100",
        "No re-fund",
      ],
    },
    {
      ...
      badgeColor: "bg-primary",
      features: [
        "Ai detailed chat for 10 input-responses plus relistic speak aloud feature",
        "2 topics for quiz",
        "One retake each",
        "Document analysis",
      ],
    },
    {
      ...
      badgeColor: "bg-purple-600",
      features: [
        "Ai detailed chat for 30 input-responses plus realistic speak aloud feature",
        "3 different topics for topic 2 retake each",
        "3 podcast access for 3 mins max",
      ],
    },
     {
      name: "Document Customised",
  ...
  const getDisplayedCards = () => {
    const currentPlans =
      billingCycle === "monthly" ? allPlans : payAsYouGoOptions;
    const left =
      currentPlans[(cardIndex - 1 + currentPlans.length) % currentPlans.length];
          ...
          <section className="bg-[#f5f8f6] dark:bg-black py-8 md:py-16 px-4 sm:px-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col gap-3 max-w-2xl w-full">
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-secondary dark:text-white mb-4">
                    ...
                    <span
                      ...
                      style={{ textShadow: "0 0 20px rgba(7, 188, 12, 0.6)" }}
                    >
                      Space
                    </span>
                  </h1>
                  <p className="text-sm sm:text-base md:text-lg text-secondary dark:text-gray-300 max-w-3xl">
                    Unlock the Potential of Innovation, Discover Advance tools
                    Guilding Student Toward{" "}
                ...
                <div className="w-full lg:w-auto lg:min-w-[300px] bg-white dark:bg-black rounded-xl p-4 sm:p-6 border border-[#dbe6db] dark:border-gray-700 shadow-sm">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <button
                      ...
                      className="text-xs sm:text-sm font-medium text-[#07bb0d] hover:underline"
                    >
                      Top Up
                    </button>
                  </div>
                  <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm font-medium leading-normal">
                    Current Wallet Balance
                  </p>
                  <p className="text-[#111811] dark:text-white tracking-light text-2xl sm:text-3xl font-bold leading-tight mt-1">
              ...
              <div className="relative flex items-center justify-center mt-8 lg:mt-12">
                ...
                <div className="lg:hidden relative w-full h-[500px] sm:h-[550px] flex items-center justify-center px-2 sm:px-4 overflow-visible">
                  {/* Left Card */}
                  <div
                    onClick={handlePrevious}
                  ...
                  >
                    <div
                      className={`absolute -top-3 left-1/2 transform -translate-x-1/2 ${left.badgeColor} text-white px-3 py-0.5 rounded-full text-xs font-semibold`}
                    >
                      {left.badge}
                    </div>
                    <div className="mb-4">
                    ...
                    <button
                      ...
                      className="w-full py-2 rounded-full font-bold text-sm transition-all bg-secondary dark:bg-gray-700 text-white hover:bg-secondary/90"
                    >
                      Try Free
                    </button>
                  </div>
                  ...
                  >
                    <div
                      className={`absolute -top-4 left-1/2 transform -translate-x-1/2 ${center.badgeColor} text-white px-4 py-1 rounded-full text-xs font-semibold`}
                    >
                      {center.badge}
                    </div>
                    <div className="mb-5">
                    ...
                    <div className="mb-6">
                      <div className="text-3xl font-black text-secondary dark:text-white">
                        {center.price}
                    ...
                    <button
                      onClick={() => navigate("/signup")}
                      className="w-full py-3 rounded-full font-bold mb-4 transition-all text-base bg-primary text-white hover:bg-primary/90"
                    >
                      {center.buttonText}
                    </button>
                  ...
                  >
                    <div
                      className={`absolute -top-3 left-1/2 transform -translate-x-1/2 ${right.badgeColor} text-white px-3 py-0.5 rounded-full text-xs font-semibold`}
                    >
                      {right.badge}
                    </div>
                    <div className="mb-4">
                        ...
                        {left.features.map((feature, idx) => (
                          <div key={idx} className="flex items-start gap-3">
                            <div className="flex-shrink-0 mt-0.5 w-4 lg:w-5 h-4 lg:h-5 rounded-full bg-primary flex items-center justify-center">
                              <Check
                                className="w-2 lg:w-3 h-2 lg:h-3 text-white"
                                strokeWidth={3}
                              />
                            </div>
              ...
              <section className="bg-white dark:bg-black rounded-xl p-8 border border-gray-200 dark:border-gray-700 mt-6 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-gray-600 dark:text-gray-300">
                  <div>
                    <p className="font-bold text-secondary dark:text-white mb-2">
                      How do deductions work?
                    </p>
                    <p>
                      All payments are deducted directly from your UniWallet
                      balance. Ensure you have sufficient funds before selecting
                      an option. If your balance is low, you will be prompted to
                  ...
                  <div>
                    ...
                    <p>
                      Yes, you can cancel monthly subscriptions at any time from
                      your settings. Benefits will remain active until the end
                      of the billing period. Pay-as-you-go purchases are
