...
const navLinks = [
  ...
  { name: "UniDoc", href: "https://uni-space-study.vercel.app", active: false },
...
font-medium ${link.active ? "text-primary font-bold" : "text-secondary dark:text-white"}`}
                >
                  {link.name}
                </a>
              ) : (
          ...
          {navLinks.map((link) =>
            link.href.startsWith("http") ? (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block px-4 py-3 text-sm font-medium text-secondary dark:text-white hover:bg-background-light dark:hover:bg-slate-800"
...
hover:text-primary dark:text-[#a8d5a8] dark:hover:text-primary/80"
            >
      ...
      <div
        className="mt-4 grid grid-cols-3 sm:grid-cols-4
...
const ListingSummary = ({ duration, fee, balance }) => {
  ...
  return (
    <div
      className="bg-background-light dark:bg-slate-800/50
rounded-lg p-4"
    >
      <h3
...
dark:text-white"
        ...
        <div
          className="flex justify-between font-bold text-base mt-2
text-primary"
        >
      ...
      {!hasSufficientBalance && (
        <div
          className="mt-4 p-3 bg-red-100 dark:bg-red-900/30
...
mt-0.5"
          ...
          <div>
            ...
            <p>
              Your UniWallet balance is too low. Please top up to post your
              listing.
            </p>
            <button
    ...
    <div className="relative flex min-h-screen w-full flex-col">
      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-10 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1
              className="text-secondary dark:text-white text-xl sm:text-2xl lg:text-3xl font-bold
leading-tight mb-2"
            >
              Create a New Listing
            </h1>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">
              Fill in the details below to sell your item on UniMarket.
            </p>
          </div>
          <div
...
text-slate-700 dark:text-slate-300 mb-2"
                    ...
                    <input
                      ...
                      type="text"
                      placeholder="e.g., Slightly
Used HP Elitebook 840 G5"
...
font-medium text-slate-700 dark:text-slate-300 mb-2"
                    >
                      Price (₦)
                    </label>
                    <input
                      ...
                      placeholder="e.g.,
150000"
                      className="form-input w-full rounded-lg bg-background-light
...
dark:text-white"
                    ...
                    <div className="mt-4">
                      <label
                        ...
                        className="block
text-sm font-medium text-slate-700 dark:text-slate-300 mb-2"
                      >
                        Duration:
                      ...
                      <input
                        ...
                        type="range"
                        min="1"
                        max={durationOptions[durationType].max}
                        value={durationValue}
                        onChange={(e) =>
