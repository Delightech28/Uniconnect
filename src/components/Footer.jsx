...
const Footer = ({ darkMode }) => {
  ...
  const resourcesLinks = [
    { label: "Help Center", href: "/help-and-support", protected: false },
    { label: "FAQ", href: "/faq", protected: false },
    { label: "Contact Support", href: "/contact-support", protected: false },
  ];
  ...
  return (
    <footer
      className={`${localDarkMode ? "bg-gray-900 text-gray-100" : "bg-gray-50 text-gray-900"} border-t ${localDarkMode ? "border-gray-800" : "border-gray-200"} mt-16 lg:mt-24`}
    >
      {/* Newsletter Section - only show on landing page */}
      {location.pathname === "/" && (
        <div
          className={`${localDarkMode ? "bg-gradient-to-r from-primary to-green-600" : "bg-gradient-to-r from-primary via-green-500 to-green-600"} py-12 lg:py-16`}
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-green-100 text-sm lg:text-base">
                  Get the latest updates on new features, campus stories, and
      ...
      <div className={`max-w-6xl mx-auto px-4 lg:px-10 py-12 lg:py-16`}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p
              className={`text-sm mb-6 ${localDarkMode ? "text-gray-400" : "text-gray-600"}`}
            >
              Connecting students across Nigerian universities. Your campus
              community hub for learning, selling, and building meaningful
              connections.
            </p>
          ...
          {/* Resources Links */}
          <div>
            <h5 className="font-semibold mb-4 text-sm lg:text-base">
              Resources
            </h5>
            <ul className="space-y-3">
        ...
        {/* Divider */}
        <div
          className={`h-px ${localDarkMode ? "bg-gray-800" : "bg-gray-200"} my-8`}
        ></div>

        {/* Bottom Section */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p
            className={`text-sm ${localDarkMode ? "text-gray-500" : "text-gray-600"}`}
          >
