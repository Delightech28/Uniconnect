  ...
  return (
    <li className="p-4 sm:p-6 flex items-start gap-4 hover:bg-background-light/50 dark:hover:bg-slate-800/50 transition-colors group">
      ...
      <div className="flex-grow min-w-0">
        <p
          className={`font-semibold text-secondary dark:text-white ${notification.unread ? "font-bold" : ""}`}
        >
          {notification.title}
        </p>
            ...
            {loading ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-slate-600 dark:text-slate-300 text-sm mt-2">
                  You'll see updates here when you receive messages, sell items,
                  join referrals, and more.
                </p>
              </div>
            ) : (
